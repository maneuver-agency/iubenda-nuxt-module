...
export default function ({ app }, inject) {
  ...
  const cookiePolicyId = '<%= options.config.cookiePolicyId %>'
  ...
  function getPrivacyPolicyLinkHtml(label = 'Privacy Policy') {
    return `<a
  ...
  function getCookiePolicyLinkHtml(label = 'Cookie Policy') {
    return `<a
